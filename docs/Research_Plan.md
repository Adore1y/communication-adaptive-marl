...
## 9. 论文与可交付
- 目标会议：ICML（首选），AAMAS/AAAI/IJCAI（备选）；CoRL/IROS（如增加 embodied 实验）。
- 交付：代码/配置/脚本开源；固定随机种子与 split；曲线与 CSV；方法与评测文档。
...
## 11. 本地（MacBook Pro M4）与 HPC 分工

### 11.1 本地可执行（开发/轻量实验/写作）
